    ...
    */
    ...
    'defaults' => [
        'supervisor-base' => [
            ...
            'maxTime' => 0, // Без ограничения по времени работы процесса
            'maxJobs' => 0, // Без ограничения по количеству задач на процесс
            'memory' => 128, // Ограничение памяти (MB)
        ...
        'supervisor-prices' => [
            'connection' => 'redis',
            'queue' => ['conversion-prices-parser'],
            'balance' => 'auto',
            'autoScalingStrategy' => 'time',
            'maxProcesses' => 7,
            'maxTime' => 0,
