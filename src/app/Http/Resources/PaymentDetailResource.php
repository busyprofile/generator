...
class PaymentDetailResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'unique_amount_percentage' => $this->unique_amount_percentage,
            'unique_amount_seconds' => $this->unique_amount_seconds,
            ...
            'daily_limit_raw' => $this->daily_limit->toInt(),
            'min_order_amount_raw' => $this->min_order_amount ? $this->min_order_amount->toInt() : null,
            'max_order_amount_raw' => $this->max_order_amount ? $this->max_order_amount->toInt() : null,
            'deals_amount' => $this->getAttribute('deals_amount') ?? 0,
            'is_online' => (bool) $this->is_active,
        ];
    }
}
