...
class QueriesBuilder implements QueriesBuilderContract
{
    ...
    public function providerLog(): ProviderLogQueries
    {
        return make(ProviderLogQueries::class);
    }
    
    public function providerCallbackLog(): ProviderCallbackLogQueries
    {
        return make(ProviderCallbackLogQueries::class);
    }
}
