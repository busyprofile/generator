...
<template>
    <div>
        <header>
            <h2 class="text-lg font-medium text-foreground">Информация о профиле</h2>
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-sm mt-2 text-foreground">
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        class="underline text-sm text-muted-foreground hover:text-foreground rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                    >
