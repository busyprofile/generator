...
const statisticsFormated = computed(() => {
    return {
        ...
        referralsCount: statistics.referralsCount,
        referralRate: statistics.referralRate,
    }
});
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-3 gap-6">
                        ...
                        <Card :pt="{ root: { class: 'rounded-lg' } }">
                            <template #content>
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-gray-500 dark:text-gray-400 mb-1">Комиссия</p>
                                        <p class="text-2xl font-bold dark:text-white">{{ statisticsFormated.referralRate }}%</p>
                                    </div>
                                    <div class="bg-red-100 dark:bg-red-900 p-3 w-12 h-12 rounded-xl flex items-center justify-center">
                                        <i class="pi pi-percentage text-red-600 dark:text-red-400 text-2xl"></i>
                                    </div>
                                </div>
                            </template>
                        </Card>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <Card :pt="{ root: { class: 'rounded-lg' } }">
                            <template #content>
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-gray-500 dark:text-gray-400 mb-1">Трейдеров</p>
